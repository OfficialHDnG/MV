////////////////////////////////////////////////////////////////
///   Black NotePad - 5/24/2022 8:27:42 AM - Not activated   ///
////////////////////////////////////////////////////////////////
'use strict';
game.import('mode',function(lib,game,ui,get,ai,_status){
	return {
		...
		start:function(){
			...
			var clickStart=function(){
				...
				if(active){
					...
					dialog.delete();
					ui.brawlinfo=ui.create.system('传奇',null,true);
			...
			var start=ui.create.div('',dialog.content);
		...
		brawl:{
			huanhuazhizhan:{
				name:'HID&GEM  &middot; HDnG Lore International Version',
				mode:'',
				intro:[
					'The four members of HID&GEM HDnG are shadows given a second chance at life.


The 4 were among 100 inhabitants whose tragic lives ended in a dystopian dimension called Ri 

are only shadows on Cards, but can come to the light if they can solve the mystery of who they were previously. 
To find out who they were, the 4 boys have to slowly uncover the events that happened in Ri . 
Each of the 100 candidates have a unique GLYPTIC :
an indestructible belief that one holds onto, even after transcending the boundary of life. 
As the 4 boys uncover the GLYPTIC of each 100 candidates, they will successfully remember who they were. 
The GLYPTIC  is what the 100 lived for.
In fact, the GLYPTIC  is exactly what caused the ultimate death,
 as they gave up their lives for their GLYPTIC .
...
The full 100 candidates and their GLYPTIC will be revealed over time on this official wiki. 
To the advantage of the boys, the 100 candidates are divided evenly between the four members -
which means each boy only has to choose between twenty-five candidates. The currently revealed candidates are:
Ea, candidate of Airson
Shone, candidate of Roars
Code Warlord, candidate of Airson
Nyeve, candidate of GoldenAge
Healon, candidate of X
The Unnamed Little One, candidate of X',
				],
