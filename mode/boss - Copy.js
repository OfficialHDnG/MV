...
game.import('mode',function(lib,game,ui,get,ai,_status){
    ...
    modTarget:true,
		...
		characterPack:{
			mode_boss:{
				boss_hundun:['male','qun',1171000,['enemy1234','boss_xiongshou','boss_wuzang','boss_xiangde','boss_yinzei','boss_yinzei_switch'],['qun','boss','bossallowed'],'qun'],
				...
				boss_zhuyin:['male','qun',400000000,['boss_xiongshou'],['qun','hiddenboss','bossallowed'],'qun'],
