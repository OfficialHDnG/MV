...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhugeliang:['male','shu','17600/17600',['spyajun','tianshex','glyptica_fu','nscongjun','jieyin','rende','aol','rende','jieyin','zhiheng','kurou','goldenturn','goldenturn_2','goldenturn_3','fanjian','guose','liuli','shensu','yingzi','xinjing','huanfeng','xyirangr','decadexushenDRAFT','xhuanxia','xprotection','xpaoxiao','mirror','roars','glyptic','glyptic_guanri','rende','zhiheng','ti']],
			zhaoyun:['female','wei','10000/17600',['longdan','chaoli','hptest','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
...
charlotte:true,
	prompt:'Finish the Chapter. 伊籍，字机伯，生卒年不详，兖州山阳郡（今山东金乡县）人，三国时期蜀汉官员。年少时依附于同乡刘表。刘备落难到荆州时，伊籍时常拜访',
					...
					content:function(){
'step 0'
game.log('Airson Gained new Talent: What!');
'step 1'
game.log('This is a Story');
'step 2'
game.log('对【驭】');
