...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','1/176',['jieyin','rende','aol','spjincui','spyanjiao','yingzi','glyptica_fu','qian','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			machao:['male','qun','1/176',['jieyin','rende','aol','xg','yingzi','glyptica_fu','qian','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
			sunquan:['female','wu','1/176',['jieyin','rende','aol','xx','yingzi','glyptica_fu','qian','xyirangx','xpaoxiao','x','glyptic','xpaoxiao','dx','dxf','dxg']],
