...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','10000/17600',['zhihengx','glyptica_fu','chaoli','done','longdan','hptest','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
