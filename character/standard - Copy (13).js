...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','10000/17600',['longdan','kotarou_rewrite','hptest','tianshex','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
