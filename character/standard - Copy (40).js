...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			sunquan:['female','wu','10000/17600',['jinghe','guicai','xult','eight','three','one','chaoli','guanxing','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xx','yingzi','xyirangx','xpaoxiao','x','glyptic','xpaoxiao','dx','dxf','dxg']],
