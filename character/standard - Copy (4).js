...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhugeliang:['male','shu','17600000000',['nscongjun','jieyin','rende','aol','tuxi','rende','jieyin','zhiheng','kurou','guanxing','goldenturn','goldenturn_2','goldenturn_3','fanjian','guose','liuli','shensu','yingzi','xinjing','huanfeng','xyirangr','decadexushenDRAFT','xhuanxia','xprotection','xpaoxiao','mirror','roars','glyptic','glyptic_guanri','rende','zhiheng','ti']],
			zhaoyun:['female','wei','1/176',['lijian','jieyin','rende','aol','spjincui','spyanjiao','yingzi','glyptica_fu','qian','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			machao:['male','qun','1/176',['lijian','jieyin','rende','aol','xg','yingzi','glyptica_fu','qian','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
			sunquan:['female','wu','1/176',['lijian','jieyin','rende','aol','xx','yingzi','glyptica_fu','qian','xyirangx','xpaoxiao','x','glyptic','xpaoxiao','dx','dxf','dxg']],
