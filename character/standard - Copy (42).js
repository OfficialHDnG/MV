...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','10000/17600',['jinghe','shuishi','jidian','guicai','glyptic_carve','maoding2','lanzhi_old','work','tianxiang','shiduo','kuancai','zhihengx','glyptica_fu','chaoli','done','dbne','longdan','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			machao:['male','qun','10/17600',['jinghe','guicai','feixia','feixu','glyptic_carve','areal','breal','chaoli','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xg','yingzi','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
			sunquan:['female','wu','10000/17600',['jinghe','guicai','xult','eight','three','one','chaoli','reguanxng','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xx','yingzi','xyirangx','xpaoxiao','x','glyptic','xpaoxiao','dx','dxf','dxg']],
				...
				content:function(){
					...
					if(cards.length){
						...
						for(var i=0;i<lib.inpile.length;i++){
							if(lib.card[lib.inpile[i]].type=='Shone'){
...
if(result.suit=='club'){
						event.target.damage(999);
					}
if(result.suit=='heart'){
						event.target.recover(3);
					}
if(result.suit=='diamond'){
var num=target.countCards('h',{suit:'diamond'});
						event.target.damage(500*num);
					}
				}
			},
