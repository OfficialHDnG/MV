...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','10000/17600',['zhihengx','glyptica_fu','chaoli','done','dbne','longdan','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			machao:['male','qun','10/17600',['chaoli','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xg','yingzi','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
...
player.storage.glyptic2+=310;
target.storage.glyptic3+=1.07;
					}

if(player.hasSkill('airson')){
player.storage.glyptic+=7;
player.storage.glyptic2+=451;
target.storage.glyptic3+=0.91;
					}

if(player.hasSkill('goldenage')){
player.storage.glyptic+=11;
player.storage.glyptic2+=479;
target.storage.glyptic3+=0.97;
					}

if(player.hasSkill('x')){
player.storage.glyptic+=2;
player.storage.glyptic2+=381;
target.storage.glyptic3+=1.02;
					}
