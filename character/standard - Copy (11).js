...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhugeliang:['male','shu','17600/17600',['mailun','tianshex','glyptica_fu','nscongjun','jieyin','rende','aol','rende','jieyin','zhiheng','kurou','goldenturn','goldenturn_2','goldenturn_3','fanjian','guose','liuli','shensu','yingzi','xinjing','huanfeng','xyirangr','decadexushenDRAFT','xhuanxia','xprotection','xpaoxiao','mirror','roars','glyptic','glyptic_guanri','rende','zhiheng','ti']],
			zhaoyun:['female','wei','10000/17600',['longdan','mailun','kotarou_rewrite','hptest','tianshex','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','yingzi','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			machao:['male','qun','10000/17600',['chaoli','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xg','yingzi','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
			sunquan:['female','wu','10000/17600',['chaoli','guanxing','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xx','yingzi','xyirangx','xpaoxiao','x','glyptic','xpaoxiao','dx','dxf','dxg']],
...
usable:4,
                    ...
                    if(result && result.control){
                        ...
                        player.addSkill(trans[result.control]);
player.update();                     
                    }
                },
...
target.damage(2);
	...
	game.changeCoin(100);	
target.damage(1100);
ask.set('选择一张牌，然后从牌堆中获得一张与此牌类型相同的牌。本回合内使用与此牌类型相同的牌时不可被其他角色响应。');
