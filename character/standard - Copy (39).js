...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			machao:['male','qun','10/17600',['feixia','feixu','glyptic_carve','areal','breal','chaoli','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xg','yingzi','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
