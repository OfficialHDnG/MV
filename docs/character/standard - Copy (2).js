...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhugeliang:['male','shu','17600000000',['jieyin','rende','aol','tuxi','rende','jieyin','zhiheng','kurou','guanxing','goldenturn','goldenturn_2','goldenturn_3','fanjian','guose','liuli','shensu','yingzi','xinjing','huanfeng','xyirangr','decadexushenDRAFT','xhuanxia','xprotection','xpaoxiao','mirror','roars','glyptic','glyptic_guanri','rende','zhiheng','ti']],
