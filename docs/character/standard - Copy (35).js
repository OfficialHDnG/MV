...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','10000/17600',['maoding2','lanzhi_old','work','tianxiang','shiduo','kuangcai','zhihengx','glyptica_fu','chaoli','done','dbne','longdan','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			machao:['male','qun','10/17600',['sreal','chaoli','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xg','yingzi','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
...
if (player.storage.glyptic==11){
                    'step 0'
                      var str = '请选择你的初始标记。';
                    player.chooseControl(['【ROARS】','【AIRSON】','【GOLDENAGE】','【X】','【ROARS】','【AIRSON】','【GOLDENAGE】','【X】'])
                    .set('prompt',str)
                    'step 1'
                    if(result && result.control){
                        var trans = {                            "Roars":'glyptic','Airson':'glyptic2','GoldenAge':'glyptic3','X':'glyptic4',"Joars":'glyptic','HAirson':'glyptic2','HoldenAge':'glyptic3','HX':'glyptic4'
                        };
                      // player.storage.(trans[result.control]) +=100;
player.update();}
