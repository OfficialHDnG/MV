...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhugeliang:['male','shu','17600/17600',['tianshex','glyptica_fu','nscongjun','jieyin','rende','aol','rende','jieyin','zhiheng','kurou','goldenturn','goldenturn_2','goldenturn_3','fanjian','guose','liuli','shensu','yingzi','xinjing','huanfeng','xyirangr','decadexushenDRAFT','xhuanxia','xprotection','xpaoxiao','mirror','roars','glyptic','glyptic_guanri','rende','zhiheng','ti']],
			zhaoyun:['female','wei','10000/17600',['hptest','tianshex','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','yingzi','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			...
			sunquan:['female','wu','10000/17600',['glyptica_fu','tianshex','lijian','jieyin','rende','aol','xx','yingzi','xyirangx','xpaoxiao','x','glyptic','xpaoxiao','dx','dxf','dxg']],
...
group:['glyptic_phys','glyptic_real','glyptic_skyw','glyptic_roars','glyptic_ele','glyptic_j','glyptic_m'],
			init:function(player){
