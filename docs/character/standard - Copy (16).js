...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','10000/17600',['longdan','hptest','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
...
var x=Math.random()*Math.random()*(target.hp/target.maxHp)^2;
if (x>0.015){
player.popup('Failed');
}
