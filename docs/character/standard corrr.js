...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhugeliang:['male','shu','17600/17600',['end','tianshex','glyptica_fu','nscongjun','jieyin','rende','aol','rende','jieyin','zhiheng','kurou','goldenturn','goldenturn_2','goldenturn_3','fanjian','guose','liuli','shensu','yingzi','xinjing','huanfeng','xyirangr','decadexushenDRAFT','xhuanxia','xprotection','xpaoxiao','mirror','roars','glyptic','glyptic_guanri','rende','zhiheng','ti']],
			zhaoyun:['female','wei','10000/17600',['end','longdan','hptest','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			machao:['male','qun','10000/17600',['glyptica_fu','tianshex','lijian','jieyin','rende','aol','xg','yingzi','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
			sunquan:['female','wu','10000/17600',['guanxing','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xx','yingzi','xyirangx','xpaoxiao','x','glyptic','xpaoxiao','dx','dxf','dxg']],
...
var x=math.Random()*(target.hp/5000);
...
target.popup('Failed');
	...
	if(target.hasSkill('boss_xiongshou')){
'step 0'
  var str = 'This is my story';
                    player.chooseControl('ok2').set('prompt',str);
  'step 1'
                      var str1 = 'I want to eat';
                    player.chooseControl('ok2').set('prompt',str1);
'step 2'
	game.changeCoin(100);	
...
target.damage(100000);
	...
	if(target.hasSkill('boss_yinzei')){
'step 0'
  var str3 = 'me boss';
                    player.chooseControl('ok2').set('prompt',str3);
  'step 1'
                      var str4 = 'you can win';
                    player.chooseControl('ok2').set('prompt',str4);
'step 2'
	game.changeCoin(100);	
game.saveConfig.hausen(1000);
target.damage(100000);
