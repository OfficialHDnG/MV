...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','1/17600',['gfuhun','telisi','jinghe','shuishi','jidian','guicai','glyptic_carve','maoding2','lanzhi_old','work','tianxiang','shiduo','kuancai','zhihengx','glyptica_fu','chaoli','done','dbne','longdan','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
			machao:['male','qun','1/17600',['telisi','jinghe','guicai','feixia','feixu','glyptic_carve','areal','breal','chaoli','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xg','yingzi','xyirangg','goldenturn','goldenage','glyptic','dga','dgaf','dgag']],
			sunquan:['female','wu','1/17600',['telisi','jinghe','guicai','xult','eight','three','one','chaoli','reguanxng','glyptica_fu','tianshex','lijian','jieyin','rende','aol','xx','yingzi','xyirangx','xpaoxiao','x','glyptic','xpaoxiao','dx','dxf','dxg']],
...
//dieBegin
				...
				content:function(){
					...
					if(event.targets.length){
						player.line(event.targets.shift().damage(999999,'fire'));
						event.redo();
					}
					'step 2'
					game.delay();
