...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			zhaoyun:['female','wei','1/17600',['telisi','jinghe','shuishi','jidian','guicai','glyptic_carve','maoding2','lanzhi_old','work','tianxiang','shiduo','kuancai','zhihengx','glyptica_fu','chaoli','done','dbne','longdan','misuzu_zhongyuan','glyptica_fu','lijian','jieyin','rende','aol','spyanjiao','xapgl','dairsong','dairsonf','dairson','xyiranga','airson','glyptic']],
